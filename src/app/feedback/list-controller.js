...
angular.module('inspinia')
    .controller('feedbackListCtrl', function ($scope, $state, FileUploader, feedbackService, toaster, $stateParams,configurationService, placesService, citiesService) {
        $scope.notfoundcity = "";
        $scope.notfoundplace = "";
        $scope.places = {};
        $scope.country="0";
        ...
        feedbackService.getList().then(function (data) {
        ...
        $scope.save = function (place) {
            ...
            if (error == 0) {
                feedbackService.geteventsByPlace(place).then(function (data) {
        ...
        $scope.delete = function (id) {
            console.log(id);
            feedbackService.delete(id).then(function (data) {
                console.log(data.result);
